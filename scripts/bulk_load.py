...
def generate_shortlists(
    ...
    for jid in job_ids:
        # New schema requires `job_ids` (plural). Single string is accepted
        # for back-compat and triggers the single-JD response shape.
        payload: dict[str, Any] = {"job_ids": jid, "threshold": threshold}
