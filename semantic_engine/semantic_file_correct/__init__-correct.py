...
# Removed get_model from the import list below
from .embedder          import embed, embed_batch, embed_resume, embed_jd, cache_stats, extract_resume_name, extract_jd_title
