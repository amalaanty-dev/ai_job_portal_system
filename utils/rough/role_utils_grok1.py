...
ROLE_SYNONYMS: Dict[str, List[str]] = {
    ...
    "medical data analyst": [
        ...
        "healthcare domain medical data",           # ← Your current role
        "medical data domain analyst",
        "healthcare medical data analyst",
        "domain medical data analyst"
    ],
    ...
    "healthcare data analyst": [                    # ← Main canonical for most healthcare data roles
        ...
        "learn languages healthcare data associate",   # ← Your previous role
        "healthcare data associate learn languages",
        "healthcare data role"
    ],
...
def normalize_role(role: str) -> str:
    ...
    for variant in _ROLE_CANONICAL_MAP:
...
# Optional: Add new synonym dynamically
