...
def _is_achievement_line(line: str) -> bool:
    ...
    ach_keywords = ["awarded", "top performer", "commendation", "recognition", "rewarded", "secured fd", "performance award"]
    cleaned = line.lower()
...
def _looks_like_job_header(line: str) -> bool:
    ...
    academic_keywords = ["university", "college", "school", "bba", "mba", "btech", "b.sc", "b.com", "degree", "percentage", "%"]
    cleaned = line.lower()
