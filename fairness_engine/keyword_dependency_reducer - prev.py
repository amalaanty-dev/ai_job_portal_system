...
class KeywordDependencyReducer:
    ...
    def __init__(self, output_dir: str = "fairness_engine_outputs/normalized_scores"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="fairness_engine_outputs/normalized_scores")
